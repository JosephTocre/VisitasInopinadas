...
export async function GET(request: Request) {
  try {
    ...
    // Iterar sobre cada visita y crear una página (o varias)
    for (const visita of visitas) {
      // Creamos una nueva página para cada visita
      const page = pdfDoc.addPage([595, 842]);
      const font = await pdfDoc.embedFont(StandardFonts.Helvetica);
      const fontB = await pdfDoc.embedFont(StandardFonts.HelveticaBold);

      // Reiniciar el cursor de fila
      let rowTop = 795;
      const L = 28;
      const W = 539;
      ...
      const docenteNombre =
        `${str(cd?.docente.nombre_docente)} ${str(cd?.docente.apellido_docente)}`.trim();
      const responsable =
        `${str(visita.usuario?.nombre)} ${str(visita.usuario?.apellidos)}`.trim();
      ...
      const labelCell = (
        ...
        text(
          ...
          x + 2,
          y - h + (h - 7) / 2 + 0.5,
          boldLabel ? fontB : font,
          6.5,
        );
        text(
          page,
          value,
          x + font.widthOfTextAtSize(label, 6.5) + 5,
          y - h + (h - 7) / 2 + 0.5,
          font,
          7,
        );
      ...
      const valueCell = (
        ...
        drawRect(page, x, y - h, w, h, fill ? { fill } : {});
      ...
      // ─────────────────────────────────────────────────────────────────────
      {
        ...
        labelCell(
          ...
          visita.hora_inicio?.toLocaleTimeString("es-PE") ?? "",
          L + colW,
          top,
          colW,
          h,
        ...
        labelCell(
          ...
          visita.hora_termino?.toLocaleTimeString("es-PE") ?? "",
          L + colW * 2,
          top,
          colW,
          h,
      ...
      // ─────────────────────────────────────────────────────────────────────
      {
        ...
        labelCell(
          "SEMANA N°:",
          visita.n_semana != null ? String(visita.n_semana) : "",
          L,
          top,
          colW,
          h,
        ...
        labelCell(
          ...
          str(visita.hora_practica_teoria),
          L + colW,
          top,
          colW,
          h,
      ...
      // docente header row
      {
        ...
        page.drawLine({
          start: { x: L + labelW, y: top - h },
          end: { x: L + labelW, y: top },
          thickness: 0.5,
        });
      ...
      // valores de control docente
      {
        ...
        valueCell(
          ...
          presW / 2,
          h,
          cd?.presente === true ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          cd?.presente === false ? "X" : "",
          L + nameW + presW / 2,
          ...
          presW / 2,
          h,
          cd?.presente === false ? rgb(1, 0.9, 0.4) : undefined,
        );

        valueCell(
          cd?.horario_programado === true ? "X" : "",
          L + nameW + presW,
          top,
          horW / 2,
          h,
          cd?.horario_programado === true ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          cd?.horario_programado === false ? "X" : "",
          L + nameW + presW + horW / 2,
          top,
          horW / 2,
          h,
          cd?.horario_programado === false ? rgb(1, 0.9, 0.4) : undefined,
        );

        valueCell(
          cd?.interaccion === true ? "X" : "",
          L + nameW + presW + horW,
          top,
          intW / 2,
          h,
          cd?.interaccion === true ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          cd?.interaccion === false ? "X" : "",
          L + nameW + presW + horW + intW / 2,
          top,
          intW / 2,
          h,
          cd?.interaccion === false ? rgb(1, 0.9, 0.4) : undefined,
        );
      }
...

      {
        ...
        headerCell(
          "Observaciones",
          L + ctrlW + ambCumpleW + ambNoCumpleW,
          top,
          ambObsW,
          h,
          6,
        ...
        headerCell(
          "Observaciones",
          L + ambW + intraCumpleW + intraNoCumpleW,
          top,
          intraObsW,
          h,
          6,
...

      {
        ...
        valueCell(
          bool(ce?.control_ambiente),
          L + ctrlW,
          top,
          ambCumpleW,
          h,
          ce?.control_ambiente === true ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          ce?.control_ambiente === false ? "X" : "",
          L + ctrlW + ambCumpleW,
          top,
          ambNoCumpleW,
          h,
          ce?.control_ambiente === false ? rgb(1, 0.9, 0.4) : undefined,
        );
        drawRect(
          page,
          L + ctrlW + ambCumpleW + ambNoCumpleW,
        ...
        leftText(
          page,
          ce?.observaciones_ambiente ?? "",
          L + ctrlW + ambCumpleW + ambNoCumpleW + 2,
          top - h,
          ambObsW - 4,
          h,
          font,
        ...
        valueCell(
          bool(ce?.control_intranet),
          L + ambW,
          top,
          intraCumpleW,
          h,
          ce?.control_intranet === true ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          ce?.control_intranet === false ? "X" : "",
          L + ambW + intraCumpleW,
          top,
          intraNoCumpleW,
          h,
          ce?.control_intranet === false ? rgb(1, 0.9, 0.4) : undefined,
        );
        drawRect(
          page,
          L + ambW + intraCumpleW + intraNoCumpleW,
        ...
        leftText(
          page,
          ce?.observaciones_intranet ?? "",
          L + ambW + intraCumpleW + intraNoCumpleW + 2,
          top - h,
          intraObsW - 4,
          h,
          font,
      ...
      const silaboLabelW = 300,
        silaboColW = (W - silaboLabelW) / 2;
      ...
      const silaboRow = (label: string, value: boolean | null | undefined) => {
        ...
        valueCell(
          ...
          silaboColW,
          h,
          value === true ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          value === false ? "X" : "",
          L + silaboLabelW + silaboColW,
      ...
      const guiaLabelW = 270,
        guiaColW = (W - guiaLabelW) / 3;
      ...
      const guiaRow = (
        ...
        valueCell(
          ...
          guiaColW,
          h,
          isCumple ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          noCumple,
          L + guiaLabelW + guiaColW,
          ...
          guiaColW,
          h,
          isNoCumple ? rgb(1, 0.9, 0.4) : undefined,
        );
        valueCell(
          noAplica,
          L + guiaLabelW + guiaColW * 2,
          ...
          guiaColW,
          h,
          isNoAplica ? rgb(1, 0.9, 0.4) : undefined,
        );
      };
      guiaRow(
        "CUMPLE CON EL TEMA PROGRAMADO EN LA GUÍA DE PRÁCTICA PARA\nEL DESARROLLO DE LA CLASE PRÁCTICA",
        cg?.tema_programado,
      );
      guiaRow(
    ...
    return new NextResponse(Buffer.from(pdfBytes), {
      headers: {
        ...
        "Content-Disposition": `inline; filename=reporte-visitas.pdf`,
      },
    });
  } catch (error) {
    console.error(error);
